...
public class BaseInterceptor extends HandlerInterceptorAdapter {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        LogTool.info(request.getRemoteAddr(),this.getClass());//IP地址
        LogTool.info(request.getRequestURL().toString(),this.getClass());//请求的URL
		LogTool.info(controllerName+"."+method,this.getClass());//请求的controller
		LogTool.print(reqMap,this.getClass());//请求的参数
		...
		if(profile!=null){
			...
			System.out.println(profile.getId());//用户ID用户ID用户ID用户ID用户ID
